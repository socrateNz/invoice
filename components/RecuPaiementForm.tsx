...
interface Props {
  onDataChange: (d: RecuPaiementData) => void;
  initialData: RecuPaiementData;
  signatures?: Record<string, string>;
  onSignatureChange?: (slot: string, dataUrl: string | null) => void;
}

export default function RecuPaiementForm({ onDataChange, initialData, signatures = {}, onSignatureChange = () => {} }: Props) {
  const { register, watch } = useDocumentForm<RecuPaiementData>(initialData, onDataChange);
  ...
  return (
    <div className="space-y-1">
      ...
      <TemplateSelector register={register} watch={watch} name="template" gradientFrom="#166534" gradientTo="#15803d" options={[
      ...
      <div className={SC}>
        ...
        <div className={SB}>
          ...
          <SignatureField label="Le Payeur" value={signatures.payeur} onChange={(v) => onSignatureChange("payeur", v)} />
        </div>
      </div>
